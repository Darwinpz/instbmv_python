$(document).ready( function () {
    ...
    $('#table_usuarios tbody').on("click", ".btn-eliminar-usuario", function (){
        ...
        if(pregunta){
            ...
            $.ajax({
                ...
                alert(datos.nombre + " Eliminado correctamente")
    ...
    $('#table_usuarios tbody').on("click", ".btn-editar-usuario", function (){
